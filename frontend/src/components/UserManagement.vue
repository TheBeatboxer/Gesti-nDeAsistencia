  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <div class="bg-white p-4 rounded shadow mb-4">
      ...
      <div class="overflow-x-auto">
        ...
        <thead><tr><th class="p-2">Nombre</th><th class="p-2">Email</th><th class="p-2">Área</th><th class="p-2">Turno</th><th class="p-2">Código</th><th class="p-2">Acciones</th></tr></thead>
        <tbody>
...
export default {
  setup() {
    ...
    const newUser = ref({ name: '', email: '', password: '', role: '', area: '', turno: '', codigo: '' });
    ...
    async function createUser() {
      try {
        ...
        newUser.value = { name: '', email: '', password: '', role: '', area: '', turno: '', codigo: '' };
        fetchUsers();
